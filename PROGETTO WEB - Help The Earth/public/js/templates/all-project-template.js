...
function createTable(title) {
    return`<div class="hero__back" id="hero-section">
                <div class="hero__content">
                    <h1 class="big-text tw">Help The Earth</h1>
                </div>
            </div>

            <div class="bg-cover margintop-3">
                <div class="bg-cover__title">
                    <h3 class="big-text tw">${title}</h3>
                    <br>
                    <a href="/add-project" class="${(title !== 'Progetti che hai creato') ? 'visually-hidden' : ''} button margintop-0">Crea un nuovo progetto</a>
                </div>
                <div class="bg-cover__text" id="my-contain">
                </div>
            </div>
...
function createProjectRow(proj) {
    return`<a href="/project/${proj.id}" class="no-link"><div class="polaroid cursor-pointer margintop-0">${proj.title}</div></a>`;
}

function createDocumentRow(doc) {
    return`<a href="/document/${doc.id}" class="no-link"><div class="polaroid cursor-pointer margintop-0">${doc.title}</div></a>`;
}

export {createTable, createProjectRow, createDocumentRow};