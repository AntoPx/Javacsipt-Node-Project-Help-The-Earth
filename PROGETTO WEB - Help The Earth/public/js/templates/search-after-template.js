...
function createSearchPageAfter(arraySearch, projects, documents) {
    ...
    for(const project of projects) {
        projectsFind += `
        <div class="polaroid cursor-pointer"><a href="/project/${project.id}" class="no-link">
    ...
    for(const doc of documents) {
        documentsFind += `
        <div class="polaroid cursor-pointer"><a href="/document/${doc.id}" class="no-link">
            <div>${doc.title}</div>
    ...
    return `
    <section class="category margintop-3">
                ...
                <div class="col">
                    <h3 class="big-text tw"> 
                        ...
                        <a href="/search" type="button">
                            <img src="/img-video/search.svg" alt="Icona cerca" title="nuova ricerca" class="tw">
                        </a>
                    </h3>
                    <h6 class="margintop-0 tw"> 
                        <div class="d-flex bd-highlight justify-content-around">
                            <span>Categoria: ${arraySearch[0] === ''? '<i>Campo vuoto</i>' : arraySearch[0]}</span>
                            <span>Progetti: ${arraySearch[1] === ''? '<i>Campo vuoto</i>' : arraySearch[1]}</span>
                            <span>Documenti: ${arraySearch[2] === ''? '<i>Campo vuoto</i>' : arraySearch[2]}</span>
                        </div>
                    </h6>
                    <div class="container">
                        <h3 class="margintop-0 tw">Progetti</h2>
                        ${projectsFind}
                    </div>
                    <div class="container">
                        <h3 class="margintop-0 tw">Documenti</h2>
                        ${documentsFind}
                    </div>
                </div>
            </div>
...
export default createSearchPageAfter;